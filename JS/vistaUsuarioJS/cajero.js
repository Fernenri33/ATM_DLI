class Billete {
  ...
  function entregarDinero() { // funcion disparada al hacer click a extraer
    ...
    if (dinero > 0) { // despues de las iteraciones vuelvo a preguntar si dinero > 0 (porque de pronto pedi mas de lo que el me puede dar)
      resultado.innerHTML = "Solo se pueden retirar <br> cantidades multiplos de 5"; //es como un document.write
  ...
  function recargar() {
    ...
    if (monto == 100 || monto == 50 || monto == 20 || monto == 10 || monto == 5) {
      ...
      resultado.innerHTML = ("Valor no valido, <br> por favor indicar los valores <br> correspondientes para depositar" + "<hr />");
    }
  }
  ...
  var imagenes = {};
  imagenes["100"] = "../../img/cien.png";
  imagenes["50"] = "../../img/cincuenta.png";
  imagenes["20"] = "../../img/veinte.png";
  imagenes["10"] = "../../img/diez.png";
  imagenes["5"] = "../../img/cinco.png";
